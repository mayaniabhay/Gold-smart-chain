                        ...
                        <div className='md:flex'>
                            ...
                            <div>
                                <div className=' md:ml-20 md:mt-8 w-[396px]  rounded bg-white   md:w-[750px] md:h-[544px]  h-full  shadow-md shadow-black'>
                                    <h4 className='ml-2 font-bold text-sm'>Withdrawal STAND or SOLID</h4>
                                    <div className='md:ml-36 mt-16'>
                                            ...
                                            <div className='bg-slate-100 md:w-[430px] h-[84px]'>
                                                <div>
                                                    <div className='flex justify-center '>
                                                        <p className='  text-sm mr-4 mt-5'>0xE38fb5DD1c837b4DF808ea07468c0dDfF979e455</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className=''>
                                            ...
                                            <div className='flex justify-center md:mt-9 mt-14 md:-ml-36 '>
                                                <button className='md:mt-10  bg-[#cea666] text-white rounded-full w-28 h-9 shadow-lg shadow-slate-300'>Withdrawal</button>
                                            </div>
                                            <div className='flex justify-center mt-8 md:mt-6 md:-ml-36'>
                                                <p className='md:mt-6 flex justify-center'>Commission: 0.001<span className='mt-1 ml-2'><Image src={RewardLogo} alt='logo' /></span></p>
                                            </div>
